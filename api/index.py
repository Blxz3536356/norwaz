...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "8E829"
        self.SecretKey: str = "UO4Y98I31EEJEQIOBG7C4KOH38W1EQT39R3SDSTRHADF3HDFI5"
        self.ApiKey: str = "OC|9471324742902504|ce1da7ec39db66172e3bae05f86fe7f4"
...
def title_data():
    response = requests.post(
        url=f"https://8E829.playfabapi.com/Server/GetTitleData",
        headers={
            "content-type": "application/json",
            "X-SecretKey": "UO4Y98I31EEJEQIOBG7C4KOH38W1EQT39R3SDSTRHADF3HDFI5",
        },
    )
